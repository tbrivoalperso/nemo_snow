MODULE dom_oce
  ...
  !! time & space domain namelist
   ...
   CHARACTER(LEN=200), PUBLIC :: cn_topolvl
   CHARACTER(LEN=200), PUBLIC :: cn_fisfd
   CHARACTER(LEN=132), PUBLIC :: cn_bath
   CHARACTER(LEN=132), PUBLIC :: cn_bathlvl
   CHARACTER(LEN=132), PUBLIC :: cn_visfd
   CHARACTER(LEN=132), PUBLIC :: cn_fcoord
